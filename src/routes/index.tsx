      ...
      <section className="section-cream border-b border-ink/10">
        <div className="mx-auto grid max-w-[1360px] items-start gap-12 px-6 py-16 sm:px-10 sm:py-20 lg:grid-cols-[47%_53%] lg:gap-4 lg:px-4 lg:py-28">
          <div className="min-w-0">
            ...
            <h2 className="archive-question mt-10 whitespace-nowrap text-[clamp(2.4rem,9.5vw,4rem)] text-ink sm:mt-12 md:text-[5.5vw] lg:mt-14 lg:text-[clamp(2.5rem,6.6vw,5.5rem)] lg:tracking-[-0.01em]">
              BEING HUMAN IS
              <br />
              WHAT WE ARE
              <br />
