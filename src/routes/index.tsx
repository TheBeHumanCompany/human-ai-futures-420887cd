    ...
    <>
      ...
      <section className="section-ink grain relative isolate overflow-hidden border-b border-border">
        <img
          ...
          width={1600}
          height={1200}
          className="absolute inset-0 -z-20 h-full w-full origin-center scale-[1.35] object-cover object-[40%_22%] translate-x-[14%] sm:scale-[1.2] sm:translate-x-[12%] sm:object-[45%_28%] lg:scale-[1.18] lg:translate-x-[13%] lg:object-[42%_30%]"
        />
