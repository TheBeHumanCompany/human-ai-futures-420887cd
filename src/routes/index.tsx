        ...
        <div className="mx-auto max-w-[1200px] px-5 py-16 sm:px-8 md:py-16 lg:py-24">
          ...
          <div className="mt-12 bg-cream px-6 py-5 sm:px-8 sm:py-6 lg:mt-16">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-5" aria-label="Podcast platforms">
                {/* Apple Podcasts */}
                ...
                {/* Amazon Music */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.2 14.3c-.36.42-.88.66-1.44.66-.56 0-1.08-.24-1.44-.66-.36-.42-.5-.98-.4-1.52h1.92c-.06.2.04.44.22.56.18.12.42.08.56-.08.14-.16.16-.4.04-.58-.12-.18-.36-.26-.58-.22-.22.04-.38.24-.38.46h-4.6c0-1.32.7-2.52 1.8-3.2.56-.36 1.22-.56 1.9-.56s1.34.2 1.9.56c1.1.68 1.8 1.88 1.8 3.2 0 .46-.1.9-.26 1.3-.16.4-.42.74-.74 1zM8.5 8c.28 0 .5.22.5.5v5c0 .28-.22.5-.5.5h-1c-.28 0-.5-.22-.5-.5v-5c0-.28.22-.5.5-.5h1zm7 0c.28 0 .5.22.5.5v5c0 .28-.22.5-.5.5h-1c-.28 0-.5-.22-.5-.5v-5c0-.28.22-.5.5-.5h1z" />
                </svg>
                {/* iHeartRadio */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                  <path d="M6 9h2v7H6zm5-2h2v9h-2zm5 2h2v7h-2z" />
                </svg>
                {/* YouTube */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
                ...
                {/* Stitcher */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
                  <path d="M4 7h3v10H4zm5-2h3v14H9zm5 2h3v10h-3zm5-2h3v14h-3z" />
                </svg>
                {/* Pocket Casts */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-4 8c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm8 0c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-4 5c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z" />
                </svg>
                {/* RSS */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-ink" aria-hidden>
