...
export const Route = createFileRoute("/be-human-ai/ai-strategy")({
  head: () => ({
    meta: [
      { title: "Intelligence Strategy — Transform Your Business | Be Human Intelligence" },
      {
        name: "description",
        content:
          "Opportunity ranking, workflow transformation and a 90-day roadmap — ranked by business value and effort, not by what is trending.",
      },
      { property: "og:title", content: "Intelligence Strategy — Transform Your Business" },
      {
        property: "og:description",
        content:
          "Use the machines where they create leverage. Keep humans where they create advantage.",
      },
    ],
  }),
...
const SECTIONS: readonly PillarSection[] = [
  {
    ...
    body: (
      <p>
        ...
        machine intelligence creates the greatest impact. Run in the other order, an opportunity map
        becomes a list of things the organization is not yet able to do safely.
      </p>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          ...
          uncertain, and leaders cannot say clearly where machine intelligence creates value or
  ...
  },
  {
    ...
    body: (
      <p>
        The organizations creating the greatest advantage are not the ones adopting the most tools.
        They are redesigning how people, process, and technology work together. That work happens
        inside specific workflows, with the people who run them.
      </p>
    ),
  },
  {
...
const FOCUS = ["Opportunity ranking", "Workflow transformation", "90-day roadmap"] as const;

function AiStrategy() {
  return (
    <PillarPage
      kicker="Be Human Intelligence · Transform your business"
      title="Intelligence Strategy"
      lede="Where machine intelligence creates real business leverage in your organization, ranked and sequenced — and where human judgment stays in charge."
