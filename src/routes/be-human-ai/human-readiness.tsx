...
export const Route = createFileRoute("/be-human-ai/human-readiness")({
  head: () => ({
    meta: [
      { title: "Human Readiness — Prepare Your People | Be Human Intelligence" },
      {
        name: "description",
        content:
          "Leadership readiness, employee tool usage, culture and confidence. The people work that has to happen before adoption can stick.",
      },
      { property: "og:title", content: "Human Readiness — Prepare Your People" },
      {
        property: "og:description",
        content: "Every successful transformation starts with leadership, not technology.",
      },
    ],
  }),
...
const SECTIONS: readonly PillarSection[] = [
  {
    ...
    body: (
      <>
        <p>
          Every successful transformation starts with leadership — not technology. Before employees
          can adopt these tools with confidence, leaders need clarity on where machine intelligence
          belongs, where judgment does not bend, and how the organization must evolve.
        </p>
        <p>
          Without that clarity, teams begin solving the same problems in different ways. Processes
          drift. Decisions become inconsistent. The technology does not create that chaos. It
          accelerates it.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Resistance to these tools is rarely a skills gap. It is uncertainty about what the
          technology means for a person's judgment, their standing, and their job. Training that
          ignores that produces attendance, not adoption.
        </p>
        <p>
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        and only then determine where machine intelligence creates the greatest leverage.
      </p>
    ),
  },
];

const FOCUS = ["Leadership readiness", "Employee tool usage", "Culture", "Confidence"] as const;

function HumanReadiness() {
  return (
    <PillarPage
      kicker="Be Human Intelligence · Prepare your people"
      title="Human Readiness"
      lede="The people side of transformation: what leaders need to decide, what employees are already doing, and what has to be true before adoption sticks."
